...
I did not intend to publish this article as I primarily wrote it for myself. The technology I write about here is very old and there are probably not many projects dealing with it anymore. Moreover, people who still work with COM (Component Object Model) today do not need any tutorials anymore. Everything that needed to be said or written has already been said or written. I write this article mainly against forgetting. My own forgetting. Knowledge that is not maintained through frequent use tends to become increasingly superficial over time, until it eventually disappears completely. This became clear to me while writing this article, because I realized, for example, that I should write not only about IUnknown but also about IDispatch. Without IDispatch, there is no scripting of COM and scripting languages like JavaScript or Python are indispensable today. And so the article became longer and longer. It is probably too long, much too long, to give it to anyone to read at all. But, I wrote it for myself, against forgetting. Or better to say, so I can forget all this in peace, because now I have written it somewhere. I even recorded a YouTube video where I talk about all this and show practical examples, but I'm not sure if I should show it to the public. I'm not a YouTuber. I don't even have a decent microphone. Let's see, maybe I will release it after all. We'll see.
## Introduction
